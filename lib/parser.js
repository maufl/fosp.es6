  ...
  parseMessage(raw) {
    ...
    try {
      ...
      if ( raw instanceof ArrayBuffer ) {
        [msg, seq] = parseMessageBuffer(raw)
        defer.resolve(msg, seq)
      }
      else if ( typeof raw === 'string' ) {
        [msg, seq] = parseMessageString(raw)
        defer.resolve(msg, seq)
      }
      else {
